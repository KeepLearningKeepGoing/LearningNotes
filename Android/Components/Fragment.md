...
这里值得注意的是，如果activity中已经有fragment1然后添加了fragment2，遮住了fragment1，此时不会触发fragment1的任何生命周期方法，包括onHiddenChanged方法。也就是说，fragment的生命周期方法不会由fragment之间的遮盖触发。onHiddenChanged方法只会有hide和show方法触发
